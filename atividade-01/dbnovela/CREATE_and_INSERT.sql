...
VALUES (
        1,
        'P.O. Box 367, 1871 Nibh St.',
        '2017-05-02',
        8
    ),
    (
        2,
        'Ap #321-3760 Vulputate, Av.',
        '2017-11-27',
        6
    ),
    (
    ...
    (
        9,
        'Ap #219-2153 Vulputate, Road',
        '2012-02-26',
        10
    ),
    (
        10,
        'Ap #477-7378 Ornare Street',
        '2011-12-19',
        1
    );
...
CREATE TABLE `tbnovelapersonagem` (
    `codigo_novela` int(11) DEFAULT NULL,
    `codigo_personagem` int(11) DEFAULT NULL
) ENGINE = MyISAM DEFAULT CHARSET = latin1;
